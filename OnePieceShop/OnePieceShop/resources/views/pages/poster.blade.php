    ...
    <div class="small-container">
        <div class="row row-2">
            ...
            <select onchange="location = this.value;">
                ...
                <option value="{{ route('poster') }}" selected>Poster Images</option>
        ...
        @foreach($posterProdects->chunk(12) as $posterProdectChunk)
        <div class="row">
            <?php $counter = 1; ?>
            @foreach($posterProdectChunk as $posterProdect)
                <?php $poster = 'poster' . $counter; ?>

            <div class="col-4">
                <a href="{{route(<?php echo $poster; ?>)}}"><img src="{{ $posterProdect->poster_imagePath }}"></a>
                <h4>{{ $posterProdect->poster_title }}</h4>
                <div class="rating">
                ...
                <p>{{ $posterProdect->poster_price }} THB</p>
            </div>
            <?php $counter += 1; ?>
            @endforeach
        </div>
