                ...
                <div class="col-2">
                    ...
                    <div class="form-container">
                        ...
                        <form action="{{ route('signIn') }}" method="post">
                            ...
                            <button type="submit" class="btn-explore">Sign In</button>
                        ...
                        <!-- <div class="btnSign">
                            <a href="{{ route('signIn') }}"><button class="buttonSignIn" style="vertical-align:middle"><span>Sign In </span></button></a>
                            <br>
                            <a href="{{ route('signUp') }}"><button class="buttonSignUp">Sign Up</button></a>
                        </div> -->
                        ...
                        @endif
                        <form id="LoginForm" action="{{ route('account') }}" method="post">
                            {{ csrf_field() }}
                            <input type="text" id="email" name="email" placeholder="Email">
                            <input type="password" id="password" name="password" placeholder="Password">
                        ...
                        @endif
                        <form id="RegForm" action="{{ route('account') }}" method="post">
                            {{ csrf_field() }}
