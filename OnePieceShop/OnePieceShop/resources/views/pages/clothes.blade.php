...
<head>
    ...
    <title>All Products | Clothes</title>
</head>
    ...
    <div class="small-container">
        <div class="row row-2">
            ...
            <select onchange="location = this.value;">
                ...
                <option value="{{ route('clothes') }}" selected>Clothes</option>
                <option value="{{ route('accessories') }}">Accessories</option>
                <option value="{{ route('sundry') }}">Sundry</option>
            </select>
        </div>

        <!-- @foreach($clothProdects->chunk(12) as $clothProdectChunk)
        <div class="row">
            @foreach($clothProdectChunk as $clothProdect)
            <div class="col-4">
                <a href="{{ route('shirt10') }}"><img src="{{ $clothProdect->cloth_imagePath }}"></a>
                <h4>{{ $clothProdect->cloth_title }}</h4>
                <div class="rating">
                ...
                <p>{{ $clothProdect->cloth_price }} THB</p>
            </div>
            @endforeach
        </div>
        @endforeach -->
