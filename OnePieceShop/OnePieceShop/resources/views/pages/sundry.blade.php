...
<head>
    ...
    <title>All Products | Sundry</title>
</head>
    ...
    <div class="small-container">
        <div class="row row-2">
            ...
            <select onchange="location = this.value;">
                ...
                <option value="{{ route('sundry') }}" selected>Sundry</option>
            </select>
        </div>

        <!-- @foreach($sundryProdects->chunk(12) as $sundryProdectChunk)
        <div class="row">
            @foreach($sundryProdectChunk as $sundryProdect)
            <div class="col-4">
                <a href="{{ route('sundry3') }}"><img src="{{ $sundryProdect->sundry_imagePath }}"></a>
                <h4>{{ $sundryProdect->sundry_title }}</h4>
                <div class="rating">
                ...
                <p>{{ $sundryProdect->sundry_price }} THB</p>
            </div>
            @endforeach
        </div>
        @endforeach -->
