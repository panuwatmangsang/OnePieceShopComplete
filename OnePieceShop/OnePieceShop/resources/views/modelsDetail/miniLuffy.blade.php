...
<body>
    ...
    <div class="small-container single-product">
        <div class="row">
            @foreach($model as $MiniLuffy)
            <div class="col-2">
                <img src="{{ $MiniLuffy->model_imagePath }}" id="ProductImg" width="100%" height="500">
            ...
            <div class="col-2">
                <p>Home / Models</p>
                <h1>{{ $MiniLuffy->model_title }}</h1>
                <h4>{{ $MiniLuffy->model_price }} THB</h4>
