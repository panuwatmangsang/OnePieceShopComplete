...
<body>
    ...
    <!------------- single product details ------------->
        <div class="small-container single-product">
            <div class="row">
                @foreach($model as $kaido)
                <div class="col-2">
                    <img src="{{ $kaido->model_imagePath }}" id="ProductImg" width="100%" height="500">
                ...
                <div class="col-2">
                    <p>Home / Models</p>
                    <h1>สี่จักรพรรดิโจรสลัด {{ $kaido->model_title }}</h1>
                    <h4>{{ $kaido->model_price }} THB</h4>
                    <input type="number" value="1">
                    <a href="{{ url('addToCart') }}" class="btn-explore">Add To Cart</a>
